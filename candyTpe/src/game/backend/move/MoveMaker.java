...
public class MoveMaker {
	...
	private void initMap(){
		...
		map.put(new Hazelnut().getKey() + new TimerCandy().getKey(), new CandyMove(grid));
		...
		map.put(new Cherry().getKey() + new TimerCandy().getKey(), new CandyMove(grid));
		...
		map.put(new TimerCandy().getKey() + new Hazelnut().getKey(), new CandyMove(grid));
		map.put(new TimerCandy().getKey() + new Cherry().getKey(), new CandyMove(grid));
		...
		map.put(new Bomb().getKey() + new TimerCandy().getKey(), new BombMove(grid));
	}
